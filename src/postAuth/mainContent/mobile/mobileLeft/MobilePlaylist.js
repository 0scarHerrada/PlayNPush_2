        ...
        <div id='mobile-playlist'>
            ...
            <div id='sort-buttons-div'>
                <button className='sort-buttons' onClick={() => {
                    ...
                    props.sort_alpha(aZ);
                }} style={{borderColor: props.colors[3], color: props.colors[6]}} >Artists A-Z</button>
                <button className='sort-buttons' onClick={() => {
                    ...
                    props.sort_alpha(zA);
                }} style={{borderColor: props.colors[3], color: props.colors[6]}}>Artists Z-A</button>
                <button className='sort-buttons' onClick={() => {
                ...
                }} style={{borderColor: props.colors[3], color: props.colors[6]}}>Higher popularity - Lower popularity</button>
                <button className='sort-buttons' onClick={() => {
                ...
                }} style={{borderColor: props.colors[3], color: props.colors[6]}}>Lower popularity - Higher popularity</button>
                <button className='sort-buttons' onClick={() => {
                ...
                }} style={{borderColor: props.colors[3], color: props.colors[6]}}>Short songs - Long songs</button>
                <button className='sort-buttons' onClick={() => {
                ...
                }} style={{borderColor: props.colors[3], color: props.colors[6]}}>Long songs - Short songs</button>
                <button className='sort-buttons' onClick={() => {
                ...
                }} style={{borderColor: props.colors[3], color: props.colors[6]}}>Old songs - New songs</button>
                <button className='sort-buttons' onClick={() => {
                ...
                }} style={{borderColor: props.colors[3], color: props.colors[6]}}>New songs - Old songs</button>
            </div>
        </div>
    )
}
